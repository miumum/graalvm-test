...
public class ValueAssertionsTest extends AbstractGraalvmTest {
    ...
    public void isStringThatTest() {
        ...
        var exception = assertThrows(AssertionError.class, () -> assertThat(context.asValue(666))
                .isStringThat());
    ...
    public void isDoubleThatTest() {
        ...
        var exception = assertThrows(AssertionError.class, () -> assertThat(context.asValue("John Doe"))
                .isDoubleThat());
        Assertions.assertThat(exception)
